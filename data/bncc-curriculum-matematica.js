// Prof GB — Dados da BNCC (Matemática), Ensino Fundamental.
...
// /v1/habilidades?etapa=EF&componente=MA (247 habilidades).
    ...
    "2º Ano": {
        "Números": {
            ...
            "Problemas envolvendo diferentes significados da adição e da subtração (juntar, acrescentar, separar, retirar)": [
                {
                    "codigo": "EF02MA06",
                    "descricao": "Resolver e elaborar problemas de adição e de subtração, envolvendo números de até três ordens, com os significados de juntar, acrescentar, separar, retirar, utilizando estratégias pessoais ou convencionais."
                }
            ],
            "Problemas envolvendo adição de parcelas iguais (multiplicação)": [
                {
    ...
    "4º Ano": {
        ...
        "Álgebra": {
            ...
            "Propriedades da igualdade": [
                ...
                {
                    "codigo": "EF04MA15",
                    "descricao": "Determinar o número desconhecido que torna verdadeira uma igualdade que envolve as operações fundamentais com números naturais."
                }
            ]
        },
        "Geometria": {
    ...
    "7º Ano": {
        ...
        "Grandezas e medidas": {
            ...
            "Medida do comprimento da circunferência": [
                {
                    "codigo": "EF07MA33",
                    "descricao": "Estabelecer o número π como a razão entre a medida de uma circunferência e seu diâmetro, para compreender e resolver problemas, inclusive os de natureza histórica."
                }
            ]
        },
        "Probabilidade e estatística": {
