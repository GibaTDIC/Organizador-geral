...
// (conferidos código a código contra o PDF em 2026-08).
//
...
// mas — diferente de Educação Física — a BNCC não os desdobra em habilidades
// distintas por objeto: cada unidade temática tem UM bloco só de habilidades
// que cobre todos os seus objetos de conhecimento juntos. Por isso não há
// aqui um equivalente a especificacoesPorUnidade com conteúdo (fica vazio
// pra cada ano) — a cascata do formulário vai direto da unidade temática
// pras habilidades, sem nível intermediário de especificação.
...
// Nenhuma unidade temática de Arte tem sub-nível de especificação na BNCC —
// todo ano cai no fallback "vai direto pras habilidades" (ver comentário
// acima e o mesmo padrão já usado em bncc-curriculum.js pra unidades de
// Educação Física com um objeto de conhecimento só).
const SEM_ESPECIFICACAO = {};
export const especificacoesPorUnidade = {
    "1º Ano": SEM_ESPECIFICACAO,
    "2º Ano": SEM_ESPECIFICACAO,
    "3º Ano": SEM_ESPECIFICACAO,
    "4º Ano": SEM_ESPECIFICACAO,
    "5º Ano": SEM_ESPECIFICACAO,
    "6º Ano": SEM_ESPECIFICACAO,
    "7º Ano": SEM_ESPECIFICACAO,
    "8º Ano": SEM_ESPECIFICACAO,
    "9º Ano": SEM_ESPECIFICACAO
};

// ===== Bloco 1º ao 5º ano (EF15AR01-26) =====
// Objetos de conhecimento de Artes visuais: Contextos e práticas; Elementos
// da linguagem; Matrizes estéticas e culturais; Materialidades; Processos
// de criação.
...
// Objetos de conhecimento de Dança: Sistemas da linguagem; Contextos e
// práticas; Elementos da linguagem; Processos de criação.
const H15_DANCA = [
...
// Objetos de conhecimento de Música: Contexto e práticas; Elementos da
// linguagem; Materialidades; Notação e registro musical; Processos de
// criação.
const H15_MUSICA = [
...
// Objetos de conhecimento de Teatro: Contextos e práticas; Elementos da
// linguagem; Processos de criação.
const H15_TEATRO = [
...
// Objetos de conhecimento de Artes integradas: Processos de criação;
// Matrizes estéticas e culturais; Patrimônio cultural; Arte e tecnologia.
...
function unidadesBloco15() {
    return {
        "Artes visuais": { "Artes visuais": H15_ARTES_VISUAIS },
        "Dança": { "Dança": H15_DANCA },
        "Música": { "Música": H15_MUSICA },
        "Teatro": { "Teatro": H15_TEATRO },
        "Artes integradas": { "Artes integradas": H15_ARTES_INTEGRADAS }
    };
}

// ===== Bloco 6º ao 9º ano (EF69AR01-35) =====
// Objetos de conhecimento de Artes visuais: Contextos e práticas; Sistemas
// da linguagem; Elementos da linguagem; Materialidades; Processos de
// criação.
...
// Objetos de conhecimento de Dança: Contextos e práticas; Elementos da
// linguagem; Processos de criação.
const H69_DANCA = [
...
// Objetos de conhecimento de Música: Contextos e práticas; Elementos da
// linguagem; Materialidades; Notação e registro musical; Processos de
// criação.
const H69_MUSICA = [
...
// Objetos de conhecimento de Artes integradas: Contextos e práticas;
// Processos de criação; Matrizes estéticas e culturais; Patrimônio
// cultural; Arte e tecnologia.
...
function unidadesBloco69() {
    return {
        "Artes visuais": { "Artes visuais": H69_ARTES_VISUAIS },
        "Dança": { "Dança": H69_DANCA },
        "Música": { "Música": H69_MUSICA },
        "Teatro": { "Teatro": H69_TEATRO },
        "Artes integradas": { "Artes integradas": H69_ARTES_INTEGRADAS }
    };
}
